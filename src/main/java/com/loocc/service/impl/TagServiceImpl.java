...
public class TagServiceImpl implements TagService {
    ...
    private List<Long> convertToList(String ids) {
        //此处有bug,当没有一个标签的时候直接在写博客的页面输入标签会报错，后面解决
    ...
    @Override
    public int saveAll(List<Tag> tagList, JdbcTemplate jdbcTemplate) {
        return tagRepository.insertTags(tagList,jdbcTemplate);
    }
}
